...
def plot_cluster_analysis(
    ...
    # ensure deterministic numeric layer order
    layer_ids = sorted([int(k) for k in cluster_labels.keys()])
    # layerwise clusters
    total_singletons = []
    ...
    # singletons
    fig, ax = plt.subplots(figsize=(12, 6))
    sns.barplot(x=layer_ids, y=total_singletons, ax=ax)
    ax.set_xlabel("Layer")
    ...
    # non-singletons
    fig, ax = plt.subplots(figsize=(12, 6))
    sns.barplot(x=layer_ids, y=total_non_singletons, ax=ax)
    ax.set_xlabel("Layer")
    ...
    # non-singleton sizes
    fig, ax = plt.subplots(figsize=(12, 6))
    sns.barplot(x=layer_ids, y=total_non_singleton_sizes, ax=ax)
    ax.set_xlabel("Layer")
    ...
    fig, ax = plt.subplots(figsize=(12, 6))
    sns.barplot(x=layer_ids, y=average_non_singleton_sizes, ax=ax)
    ax.set_xlabel("Layer")
    ...
    fig, ax = plt.subplots(figsize=(12, 6))
    sns.barplot(x=layer_ids, y=num_remaining_experts_per_layer, ax=ax)
    ax.set_xlabel("Layer")
