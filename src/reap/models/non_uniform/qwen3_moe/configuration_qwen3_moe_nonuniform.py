...
class NonUniformQwen3MoeConfig(Qwen3MoeConfig):
    """
    Extends the upstream Qwen3 MoE config with per-layer expert counts.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if getattr(self, "architectures", None) is None:
            self.architectures = ["NonUniformQwen3MoeForCausalLM"]
...
__all__ = ["Qwen3MoeConfig", "NonUniformQwen3MoeConfig"]
