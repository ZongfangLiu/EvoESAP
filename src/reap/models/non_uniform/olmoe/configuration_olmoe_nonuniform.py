...
class NonUniformOlmoeConfig(OlmoeConfig):
    """
    Extends the upstream OLMoE config with per-layer expert counts.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if getattr(self, "architectures", None) is None:
            self.architectures = ["NonUniformOlmoeForCausalLM"]
...
__all__ = ["OlmoeConfig", "NonUniformOlmoeConfig"]
